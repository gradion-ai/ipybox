...
class CodeExecutor:
    ...
    MCP tools can be called from executed code using wrapper functions generated by
    ...
    Example:
        Generate MCP tool wrappers and execute code that uses them:
        ...
        # Execute code that calls the generated wrapper function
        code = \"\"\"
    ...
    async def stream(
        ...
        Code can call MCP tools using wrapper functions generated by
