...
| `approve_shell_cmds`   | `bool`           | Whether to require approval for ! shell commands. When enabled, each shell command triggers an ApprovalRequest before execution.                                                                            | `False`                                                                                                                                                                                                                    |
